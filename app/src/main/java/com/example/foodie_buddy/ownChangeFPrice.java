...
public class ownChangeFPrice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_own_change_fprice);

        tb = (TabLayout)findViewById(R.id.cpfoodType);
        ...
        tb.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                final ListView lv = (ListView)findViewById(R.id.cpfoodList);
                ...
                changefpriceadapter adapter = new changefpriceadapter(foods, getApplicationContext());
